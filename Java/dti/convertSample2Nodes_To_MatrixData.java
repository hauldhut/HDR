 ...
 * @author Duc-Hau
 */
public class convertSample2Nodes_To_MatrixData {
    public static void main(String[] args) throws Exception{
        //Drug-Target
        //Input
        //String BiNet_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Drug2Targets.txt";
        //String BiNet_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Drug2Targets_DrugBank.txt";
        
        //Output
        //String AssocMat12_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Mat/DrugTargetMat.txt";
        //String AssocMat21_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Mat/TargetDrugMat.txt";
        
        //String AssocMat12_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Mat/DrugTargetMat_DrugBank.txt";
        //String AssocMat21_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Mat/TargetDrugMat_DrugBank.txt";
        
        
        //DO-Enhancer
        //Input
        String BiNet_FileName = "/Users/admin/Data/UsableData/Enhancer_Data/BipartiteNets/Disease2Enhancers.txt";
        
        //Output
        //String AssocMat12_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Mat/DrugTargetMat.txt";
        //String AssocMat21_FileName = "/Users/admin/Manuscripts/71 RWR_MH/Data/Mat/TargetDrugMat.txt";
        
        String AssocMat12_FileName = "/Users/admin/Manuscripts/75 Mat4DiseaseEnhancerPrediction (DEP)/Data/UnMatched/DOIDEnhMat.txt";
        String AssocMat21_FileName = "/Users/admin/Manuscripts/75 Mat4DiseaseEnhancerPrediction (DEP)/Data/UnMatched/EnhDOIDMat.txt";
        ...
        while ((strBiNet = brBiNet.readLine()) != null) {
            ...
            String ID1 = s[0].trim();
            String[] ID2Arr = s[2].trim().split(",");
            
            Map<String, Double> ID2WeightMap = new TreeMap<>();
            for(i=0;i<ID2Arr.length;i++){
                String ID2 = ID2Arr[i].trim();
        ...
        AssocID1Set.addAll(ID12ID2WeightMap.keySet());
